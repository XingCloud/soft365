...
<div class="container-fluid">
	<div class="row-fluid">
		<form class="bs-docs-example form-horizontal" method='post'
			...
			<?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="control-group">
					<label for="inputOem" class="control-label" style='width:250px;'><?php echo ($v); ?>&nbsp;&nbsp;</label>
					<div class="controls">
						<input type="text" placeholder="<?php echo ($key); ?>" id="<?php echo ($key); ?>" name="<?php echo ($key); ?>" value="<?php echo ($data[$key]); ?>" /> <span
							class="help-inline error"><font color="#FF0000">*</font></span> <span><i
							class="icon-warning-sign"></i><?php echo ($v); ?>只能为数字</span>
					</div>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn" href="/Config/edit">取消</a>
				</div>
			</div>
		</form>
	</div>
