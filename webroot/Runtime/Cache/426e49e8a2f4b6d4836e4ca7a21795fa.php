        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="<?php if($Think.MODULE_NAME == 'Config' && $Think.ACTION_NAME == 'edit'){echo 'active';}?>"><a href="/Config/edit">全局配置</a></li><?php endif; ?>
              <li class="<?php if($Think.MODULE_NAME == 'Config' && $Think.ACTION_NAME == 'editSys'){echo 'active';}?>"><a href="/Config/editSys">系统设置</a></li>
              <li class="divider"/>
...
<div class="container-fluid">
	<div class="row-fluid">
		<form class="bs-docs-example form-horizontal" method='post'
			...
			<legend>用户信息</legend>
			<input type="hidden" name="id" value="<?php echo ($oemid['id']); ?>"/>

			<div class="control-group">
				<label for="inputOem" class="control-label">Oemid</label>
				<div class="controls">
					<input type="text" placeholder="name" id="name" name="name" value="<?php echo ($oemid['name']); ?>" /> <span
						class="help-inline error"><font color="#FF0000">*</font></span> 
				</div>
			</div>
			
			<div class="control-group">
				<label for="inputOem" class="control-label">说明</label>
				<div class="controls">
					<input type="text" placeholder="desc" id="desc" name="desc" value="<?php echo ($oemid['desc']); ?>" /> <span
						class="help-inline error"><font color="#FF0000">*</font></span> 
				</div>
			</div>
			
			<div class="control-group">
				<label for="inputOem" class="control-label">所属用户</label>
				<div class="controls">
					<select id="user_id" name="user_id">
						<option value="" >--请选择--</option>
						<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>" <?php if($v['id'] == $oemid['user_id']): ?>selected<?php endif; ?> ><?php echo ($v['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
