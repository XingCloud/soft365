	...
	<div class="row-fluid">
		<div class="row-fluid">
				<span style="float:left"><a class='btn btn-success'
					style="margin-top: 10px; margin-bottom: 10px" href="/Oemid/add"><i
				...
				<table class="table table-bordered">
					...
					<tbody>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
							<a class="btn" href="/Oemid/edit?id=<?php echo ($obj['id']); ?>"><i
									class="icon  icon-edit"></i>编辑</a>
							<a class="btn" href="/Oemid/destroy?id=<?php echo ($obj['id']); ?>"
								onclick="return confirm('确认要停用此用户吗?')"><i
