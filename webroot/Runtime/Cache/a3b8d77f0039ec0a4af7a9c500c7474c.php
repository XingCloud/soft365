...
<div class="container-fluid">
	<div class="row-fluid">
		<form class="bs-docs-example form-horizontal" method='post'
			...
			ACTION="/ContentPop/save">

			<legend>内容弹窗信息</legend>
			...
			<div class="control-group">
				<label for="inputOem" class="control-label">内容弹窗分类</label>
				<div class="controls">
					<select id="sub_type" name="sub_type">
						<option value="">--请选择--</option>
						<?php if(is_array($sub_type)): $k = 0; $__LIST__ = $sub_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($pop['sub_type'] == $k): ?>selected<?php endif; ?> ><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select> <span class="help-inline error"><font color="#FF0000">*</font></span>
				</div>
			</div>
			...
			<div class="control-group">
				<label for="inputOem" class="control-label">内容</label>
				<div class="controls">
					<textarea placeholder="text" rows="6" cols="150" id="text" name="text" /><?php echo ($pop['text']); ?></textarea><span
						class="help-inline error"><font color="#FF0000">*</font></span> 
				</div>
			</div>
			<div class="control-group">
				<label for="inputOem" class="control-label">激活应用类型</label>
				<div class="controls">
					<select id="app_type" name="app_type">
						<option value="">--请选择--</option>
						<?php if(is_array($app_type)): $k = 0; $__LIST__ = $app_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($pop['app_type'] == $k): ?>selected<?php endif; ?> ><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select> <span class="help-inline error"><font color="#FF0000">*</font></span>
				</div>
			</div>
			<div class="control-group">
					<label for="inputName" class="control-label">应用ID</label>
				<div class="controls">
					<input type="text" placeholder="app_id" id="app_id" name="app_id" value="<?php echo ($pop['app_id']); ?>"  />
					<span class="help-inline error"><font color="#FF0000">*</font><span><i
						class="icon-warning-sign"></i>应用ID只能为数字。</span></span>
				</div>	
			</div>
			
			<div class="control-group">
					<label for="inputName" class="control-label">应用名称</label>
				<div class="controls">
					<input type="text" placeholder="app_name" id="app_name" name="app_name" value="<?php echo ($pop['app_name']); ?>"  />
					<span class="help-inline error"><font color="#FF0000">*</font> 
				</div>	
			</div>
			...
			<div class="control-group">
				<label for="inputOem" class="control-label">连续弹出次数</label>
				<div class="controls">
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn" href="/ContentPop/index">取消</a>
				</div>
			</div>
		</form>
	</div>
